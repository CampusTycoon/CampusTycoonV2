...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        ...
        //// Sets the default window width/height to the values set in the Window class of the game
        configuration.setWindowedMode(Window.DEFAULT_WIDTH, Window.DEFAULT_HEIGHT);
